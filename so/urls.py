...
urlpatterns = [
    ...
    path('settings/check-margins/', views.check_salesorder_margins_form, name='check_salesorder_margins_form'),
...
urlpatterns += [
    ...
    path(
        'saparinvoices/accounts-recording/with-me/',
        accounts_recording_views.accounts_recording_with_me,
        name='accounts_recording_with_me',
    ),
    path('saparinvoices/accounts-recording/activity/', accounts_recording_views.accounts_recording_activity_log, name='accounts_recording_activity_log'),
    ...
    path('saparinvoices/<str:invoice_number>/export/', sap_salesorder_views.export_sap_ar_invoice_pdf, name='export_sap_ar_invoice_pdf'),
    ...
    path('saparcreditmemos/<str:credit_memo_number>/export/', sap_salesorder_views.export_sap_ar_creditmemo_pdf, name='export_sap_ar_creditmemo_pdf'),
