...
class SAPARInvoice(models.Model):
    ...
    subtotal_before_discount = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True, help_text="Subtotal before discount = doc_total_without_vat + TotalDiscount")
    vat_sum = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True, help_text="VatSum from API")
...
class SAPARInvoiceItem(models.Model):
    ...
    line_total_after_discount = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True, help_text="LineTotal after applying header discount (for display)")
    ...
    gross_profit = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True, help_text="Gross Profit = LineTotal after discount - cost_price (calculated)")
