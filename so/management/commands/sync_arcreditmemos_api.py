        ...
        try:
            ...
            if local_only:
                ...
                try:
                    ...
                    payload = {
                        "creditmemos": serialized_creditmemos,
                        "api_creditmemo_numbers": api_creditmemo_numbers,
                        "api_key": VPS_API_KEY,
                        "sync_metadata": {
                            "api_calls": api_calls,
                            "days_back": days_back,
                    ...
                    logger.info(f'  Sending {len(serialized_creditmemos)} credit memos to VPS...')
                    logger.info(f'  VPS URL: {vps_url}')
                    self.stdout.write(f'  Sending {len(serialized_creditmemos)} credit memos to VPS...')
